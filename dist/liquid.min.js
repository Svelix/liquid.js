...
return variable;}};if(this.strictVariables)
throw"undefined variable "+key;return null;},variable:function(markup){if(typeof markup!='string'){return null;}
...
else if(object&&Liquid.extensions.arrayTools.include(['size','first','last'],part)){object=self.strainer[part].call(this,object);if(self._isObject(object)&&'toLiquid'in object){object=object.toLiquid();}}
else{if(self.strictVariables)
throw"undefined variable "+markup;return object=null;}
...
return"Liquid error: "+(err.message?err.message:(err.description?err.description:err));},_isObject:function(obj){return obj!=null&&typeof(obj)=='object';}});Liquid.Template=Liquid.Class.extend({init:function(){this.root=null;this.registers={};this.assigns={};this.errors=[];this.rethrowErrors=false;this.strictVariables=false;},parse:function(src){this.root=new Liquid.Document(Liquid.Template.tokenize(src));return this;},render:function(){if(!this.root){return'';}
